...
export default function LoadedPlayer({...props}) {
  ...
  useEffect(() => {
    const canPlay = ReactPlayer.canPlay('https://www.youtube.com/watch?v=' + props.id);
    console.log({canPlay});
  },[])
  useEffect(() => {
    setPlaying(true);
  ...
  return (
      <div id="loadedPlayer" className="hidden" ref={ref} onMouseMove={(ev)=> handleMouseMove(ev)}>
